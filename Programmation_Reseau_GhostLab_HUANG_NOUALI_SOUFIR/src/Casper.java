...
public class Casper extends Fantome {

    private final Random random;

    public Casper(Partie partie, int x, int y) {
        super(partie, x, y, Constants.CASPER_SCORE);
        random = new Random();
    }
    ...
    public void run() {
        while (partie!=null) {
            try {
                ...
                Thread.sleep(Constants.CASPER_VITESSE);
