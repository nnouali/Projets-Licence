...
public class Spectre extends Fantome {
    private final Random random;

    public Spectre(Partie partie,int x, int y) {
        super(partie, x, y, Constants.SPECTRE_SCORE);
	...
	public void run() {
		while (partie!=null) {
            try {
                ...
                Thread.sleep(Constants.SPECTRE_VITESSE);
